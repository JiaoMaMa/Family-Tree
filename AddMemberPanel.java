    ...
    {   
        ...
        public void actionPerformed (ActionEvent event){
            if(event.getSource() == button)
                ...
                members = new JComboBox(family.getMembers());
                box3 = new JPanel();
                ...
                box4 = new JPanel();
                members2 = new JComboBox(family.getMembers());
                l8 = new JLabel();
            ...
            if(event.getSource() == newButton){
                ...
                label.setText("Fill in the information, then click \"Add\".");
                DefaultComboBoxModel model = new DefaultComboBoxModel(family.getMembers());
                DefaultComboBoxModel model2 = new DefaultComboBoxModel(family.getMembers());
